...
export class Table extends Message<Table> {
   ...
   */
  granularity = Table_TimestampGranularity.TIMESTAMP_GRANULARITY_UNSPECIFIED;
  ...
  static readonly typeName = "google.bigtable.admin.v2.Table";
...
proto3.util.setEnumType(Table_TimestampGranularity, "google.bigtable.admin.v2.Table.TimestampGranularity", [
  { no: 0, name: "TIMESTAMP_GRANULARITY_UNSPECIFIED" },
  { no: 1, name: "MILLIS" },
]);
...
// Retrieve enum metadata with: proto3.getEnumType(Table_View)
proto3.util.setEnumType(Table_View, "google.bigtable.admin.v2.Table.View", [
  { no: 0, name: "VIEW_UNSPECIFIED" },
  { no: 1, name: "NAME_ONLY" },
  { no: 2, name: "SCHEMA_VIEW" },
  { no: 4, name: "FULL" },
]);
...
export class ColumnFamily extends Message<ColumnFamily> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.bigtable.admin.v2.ColumnFamily";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "gc_rule", kind: "message", T: GcRule },
  ]);
...
export class GcRule extends Message<GcRule> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.bigtable.admin.v2.GcRule";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
export class GcRule_Intersection extends Message<GcRule_Intersection> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.bigtable.admin.v2.GcRule.Intersection";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
export class GcRule_Union extends Message<GcRule_Union> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.bigtable.admin.v2.GcRule.Union";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "rules", kind: "message", T: GcRule, repeated: true },
  ]);
