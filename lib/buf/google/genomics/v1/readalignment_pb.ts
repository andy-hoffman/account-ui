...
import { CigarUnit } from "./cigar_pb.js";
 ...
 */
export class LinearAlignment extends Message<LinearAlignment> {
  /**
  ...
  constructor(data?: PartialMessage<LinearAlignment>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.genomics.v1.LinearAlignment";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "position", kind: "message", T: Position },
    { no: 2, name: "mapping_quality", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
    { no: 3, name: "cigar", kind: "message", T: CigarUnit, repeated: true },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): LinearAlignment {
    return new LinearAlignment().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): LinearAlignment {
    return new LinearAlignment().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): LinearAlignment {
    return new LinearAlignment().fromJsonString(jsonString, options);
  }

  static equals(a: LinearAlignment | PlainMessage<LinearAlignment> | undefined, b: LinearAlignment | PlainMessage<LinearAlignment> | undefined): boolean {
    return proto3.util.equals(LinearAlignment, a, b);
  }
}
...
export class Read extends Message<Read> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.genomics.v1.Read";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "read_group_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 3, name: "read_group_set_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 4, name: "fragment_name", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 5, name: "proper_placement", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
    { no: 6, name: "duplicate_fragment", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
    { no: 7, name: "fragment_length", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
    { no: 8, name: "read_number", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
    { no: 9, name: "number_reads", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
    { no: 10, name: "failed_vendor_quality_checks", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
    { no: 11, name: "alignment", kind: "message", T: LinearAlignment },
    { no: 12, name: "secondary_alignment", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
    { no: 13, name: "supplementary_alignment", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
    { no: 14, name: "aligned_sequence", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 15, name: "aligned_quality", kind: "scalar", T: 5 /* ScalarType.INT32 */, repeated: true },
    { no: 16, name: "next_mate_position", kind: "message", T: Position },
