...
// @generated from file google/cloud/language/v1beta2/language_service.proto (package google.cloud.language.v1beta2, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 * differently.
 *
 * @generated from enum google.cloud.language.v1beta2.EncodingType
 */
...
proto3.util.setEnumType(EncodingType, "google.cloud.language.v1beta2.EncodingType", [
  { no: 0, name: "NONE" },
  { no: 1, name: "UTF8" },
  { no: 2, name: "UTF16" },
  { no: 3, name: "UTF32" },
 ...
 *
 * @generated from message google.cloud.language.v1beta2.Document
 */
export class Document extends Message<Document> {
   ...
   *
   * @generated from field: google.cloud.language.v1beta2.Document.Type type = 1;
   */
   ...
   *
   * @generated from oneof google.cloud.language.v1beta2.Document.source
   */
  source: {
    /**
  ...
  static readonly typeName = "google.cloud.language.v1beta2.Document";
 ...
 *
 * @generated from enum google.cloud.language.v1beta2.Document.Type
 */
...
proto3.util.setEnumType(Document_Type, "google.cloud.language.v1beta2.Document.Type", [
 ...
 *
 * @generated from message google.cloud.language.v1beta2.Sentence
 */
export class Sentence extends Message<Sentence> {
  /**
   * The sentence text.
   *
   * @generated from field: google.cloud.language.v1beta2.TextSpan text = 1;
   */
  text?: TextSpan;
   ...
   *
   * @generated from field: google.cloud.language.v1beta2.Sentiment sentiment = 2;
   */
  sentiment?: Sentiment;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.cloud.language.v1beta2.Sentence";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message google.cloud.language.v1beta2.Entity
 */
export class Entity extends Message<Entity> {
   ...
   * The entity type.
   *
   * @generated from field: google.cloud.language.v1beta2.Entity.Type type = 2;
   */
   ...
   *
   * @generated from field: repeated google.cloud.language.v1beta2.EntityMention mentions = 5;
   */
   ...
   *
   * @generated from field: google.cloud.language.v1beta2.Sentiment sentiment = 6;
   */
  sentiment?: Sentiment;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.cloud.language.v1beta2.Entity";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from enum google.cloud.language.v1beta2.Entity.Type
 */
...
proto3.util.setEnumType(Entity_Type, "google.cloud.language.v1beta2.Entity.Type", [
  { no: 0, name: "UNKNOWN" },
  { no: 1, name: "PERSON" },
  { no: 2, name: "LOCATION" },
 ...
 *
 * @generated from message google.cloud.language.v1beta2.Token
 */
export class Token extends Message<Token> {
   ...
   *
   * @generated from field: google.cloud.language.v1beta2.PartOfSpeech part_of_speech = 2;
   */
   ...
   *
   * @generated from field: google.cloud.language.v1beta2.DependencyEdge dependency_edge = 3;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.cloud.language.v1beta2.Token";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "text", kind: "message", T: TextSpan },
 ...
 * the text.
 *
 * @generated from message google.cloud.language.v1beta2.Sentiment
 */
export class Sentiment extends Message<Sentiment> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.cloud.language.v1beta2.Sentiment";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message google.cloud.language.v1beta2.PartOfSpeech
 */
export class PartOfSpeech extends Message<PartOfSpeech> {
  /**
   * The part of speech tag.
   *
   * @generated from field: google.cloud.language.v1beta2.PartOfSpeech.Tag tag = 1;
   */
   ...
   *
   * @generated from field: google.cloud.language.v1beta2.PartOfSpeech.Aspect aspect = 2;
   */
   ...
   *
   * @generated from field: google.cloud.language.v1beta2.PartOfSpeech.Case case = 3;
   */
   ...
   *
   * @generated from field: google.cloud.language.v1beta2.PartOfSpeech.Form form = 4;
   */
   ...
   *
   * @generated from field: google.cloud.language.v1beta2.PartOfSpeech.Gender gender = 5;
   */
   ...
   *
   * @generated from field: google.cloud.language.v1beta2.PartOfSpeech.Mood mood = 6;
   */
   ...
   *
   * @generated from field: google.cloud.language.v1beta2.PartOfSpeech.Number number = 7;
   */
   ...
   *
   * @generated from field: google.cloud.language.v1beta2.PartOfSpeech.Person person = 8;
   */
   ...
   *
   * @generated from field: google.cloud.language.v1beta2.PartOfSpeech.Proper proper = 9;
   */
   ...
   *
   * @generated from field: google.cloud.language.v1beta2.PartOfSpeech.Reciprocity reciprocity = 10;
   */
   ...
   *
   * @generated from field: google.cloud.language.v1beta2.PartOfSpeech.Tense tense = 11;
   */
   ...
   *
   * @generated from field: google.cloud.language.v1beta2.PartOfSpeech.Voice voice = 12;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.cloud.language.v1beta2.PartOfSpeech";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from enum google.cloud.language.v1beta2.PartOfSpeech.Tag
 */
...
proto3.util.setEnumType(PartOfSpeech_Tag, "google.cloud.language.v1beta2.PartOfSpeech.Tag", [
  { no: 0, name: "UNKNOWN" },
  { no: 1, name: "ADJ" },
  { no: 2, name: "ADP" },
  { no: 3, name: "ADV" },
 ...
 *
 * @generated from enum google.cloud.language.v1beta2.PartOfSpeech.Aspect
 */
...
proto3.util.setEnumType(PartOfSpeech_Aspect, "google.cloud.language.v1beta2.PartOfSpeech.Aspect", [
 ...
 *
 * @generated from enum google.cloud.language.v1beta2.PartOfSpeech.Case
 */
...
proto3.util.setEnumType(PartOfSpeech_Case, "google.cloud.language.v1beta2.PartOfSpeech.Case", [
 ...
 *
 * @generated from enum google.cloud.language.v1beta2.PartOfSpeech.Form
 */
...
proto3.util.setEnumType(PartOfSpeech_Form, "google.cloud.language.v1beta2.PartOfSpeech.Form", [
 ...
 *
 * @generated from enum google.cloud.language.v1beta2.PartOfSpeech.Gender
 */
...
proto3.util.setEnumType(PartOfSpeech_Gender, "google.cloud.language.v1beta2.PartOfSpeech.Gender", [
 ...
 *
 * @generated from enum google.cloud.language.v1beta2.PartOfSpeech.Mood
 */
...
proto3.util.setEnumType(PartOfSpeech_Mood, "google.cloud.language.v1beta2.PartOfSpeech.Mood", [
 ...
 * Count distinctions.
 *
 * @generated from enum google.cloud.language.v1beta2.PartOfSpeech.Number
 */
...
proto3.util.setEnumType(PartOfSpeech_Number, "google.cloud.language.v1beta2.PartOfSpeech.Number", [
 ...
 *
 * @generated from enum google.cloud.language.v1beta2.PartOfSpeech.Person
 */
...
proto3.util.setEnumType(PartOfSpeech_Person, "google.cloud.language.v1beta2.PartOfSpeech.Person", [
 ...
 *
 * @generated from enum google.cloud.language.v1beta2.PartOfSpeech.Proper
 */
...
proto3.util.setEnumType(PartOfSpeech_Proper, "google.cloud.language.v1beta2.PartOfSpeech.Proper", [
 ...
 *
 * @generated from enum google.cloud.language.v1beta2.PartOfSpeech.Reciprocity
 */
...
proto3.util.setEnumType(PartOfSpeech_Reciprocity, "google.cloud.language.v1beta2.PartOfSpeech.Reciprocity", [
 ...
 * Time reference.
 *
 * @generated from enum google.cloud.language.v1beta2.PartOfSpeech.Tense
 */
...
proto3.util.setEnumType(PartOfSpeech_Tense, "google.cloud.language.v1beta2.PartOfSpeech.Tense", [
 ...
 *
 * @generated from enum google.cloud.language.v1beta2.PartOfSpeech.Voice
 */
...
proto3.util.setEnumType(PartOfSpeech_Voice, "google.cloud.language.v1beta2.PartOfSpeech.Voice", [
 ...
 *
 * @generated from message google.cloud.language.v1beta2.DependencyEdge
 */
export class DependencyEdge extends Message<DependencyEdge> {
   ...
   *
   * @generated from field: google.cloud.language.v1beta2.DependencyEdge.Label label = 2;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.cloud.language.v1beta2.DependencyEdge";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from enum google.cloud.language.v1beta2.DependencyEdge.Label
 */
...
proto3.util.setEnumType(DependencyEdge_Label, "google.cloud.language.v1beta2.DependencyEdge.Label", [
  { no: 0, name: "UNKNOWN" },
  { no: 1, name: "ABBREV" },
  { no: 2, name: "ACOMP" },
  { no: 3, name: "ADVCL" },
 ...
 *
 * @generated from message google.cloud.language.v1beta2.EntityMention
 */
export class EntityMention extends Message<EntityMention> {
   ...
   *
   * @generated from field: google.cloud.language.v1beta2.EntityMention.Type type = 2;
   */
   ...
   *
   * @generated from field: google.cloud.language.v1beta2.Sentiment sentiment = 3;
   */
  sentiment?: Sentiment;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.cloud.language.v1beta2.EntityMention";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "text", kind: "message", T: TextSpan },
 ...
 *
 * @generated from enum google.cloud.language.v1beta2.EntityMention.Type
 */
...
proto3.util.setEnumType(EntityMention_Type, "google.cloud.language.v1beta2.EntityMention.Type", [
 ...
 *
 * @generated from message google.cloud.language.v1beta2.TextSpan
 */
export class TextSpan extends Message<TextSpan> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.cloud.language.v1beta2.TextSpan";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message google.cloud.language.v1beta2.ClassificationCategory
 */
export class ClassificationCategory extends Message<ClassificationCategory> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.cloud.language.v1beta2.ClassificationCategory";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "name", kind: "scalar", T: 9 /* ScalarType.STRING */ },
 ...
 *
 * @generated from message google.cloud.language.v1beta2.AnalyzeSentimentRequest
 */
export class AnalyzeSentimentRequest extends Message<AnalyzeSentimentRequest> {
  /**
   * Input document.
   *
   * @generated from field: google.cloud.language.v1beta2.Document document = 1;
   */
  document?: Document;
   ...
   * sentence sentiment.
   *
   * @generated from field: google.cloud.language.v1beta2.EncodingType encoding_type = 2;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.cloud.language.v1beta2.AnalyzeSentimentRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message google.cloud.language.v1beta2.AnalyzeSentimentResponse
 */
export class AnalyzeSentimentResponse extends Message<AnalyzeSentimentResponse> {
  /**
   * The overall sentiment of the input document.
   *
   * @generated from field: google.cloud.language.v1beta2.Sentiment document_sentiment = 1;
   */
   ...
   *
   * @generated from field: repeated google.cloud.language.v1beta2.Sentence sentences = 3;
   */
  sentences: Sentence[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.cloud.language.v1beta2.AnalyzeSentimentResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message google.cloud.language.v1beta2.AnalyzeEntitySentimentRequest
 */
export class AnalyzeEntitySentimentRequest extends Message<AnalyzeEntitySentimentRequest> {
  /**
   * Input document.
   *
   * @generated from field: google.cloud.language.v1beta2.Document document = 1;
  ...
  constructor(data?: PartialMessage<AnalyzeEntitySentimentRequest>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.cloud.language.v1beta2.AnalyzeEntitySentimentRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "document", kind: "message", T: Document },
    { no: 2, name: "encoding_type", kind: "enum", T: proto3.getEnumType(EncodingType) },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): AnalyzeEntitySentimentRequest {
    return new AnalyzeEntitySentimentRequest().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): AnalyzeEntitySentimentRequest {
    return new AnalyzeEntitySentimentRequest().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): AnalyzeEntitySentimentRequest {
    return new AnalyzeEntitySentimentRequest().fromJsonString(jsonString, options);
  }

  static equals(a: AnalyzeEntitySentimentRequest | PlainMessage<AnalyzeEntitySentimentRequest> | undefined, b: AnalyzeEntitySentimentRequest | PlainMessage<AnalyzeEntitySentimentRequest> | undefined): boolean {
    return proto3.util.equals(AnalyzeEntitySentimentRequest, a, b);
  }
}
 ...
 *
 * @generated from message google.cloud.language.v1beta2.AnalyzeEntitySentimentResponse
 */
export class AnalyzeEntitySentimentResponse extends Message<AnalyzeEntitySentimentResponse> {
  /**
   * The recognized entities in the input document with associated sentiments.
   *
   * @generated from field: repeated google.cloud.language.v1beta2.Entity entities = 1;
   */
  entities: Entity[] = [];
  ...
  constructor(data?: PartialMessage<AnalyzeEntitySentimentResponse>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.cloud.language.v1beta2.AnalyzeEntitySentimentResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "entities", kind: "message", T: Entity, repeated: true },
    { no: 2, name: "language", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): AnalyzeEntitySentimentResponse {
    return new AnalyzeEntitySentimentResponse().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): AnalyzeEntitySentimentResponse {
    return new AnalyzeEntitySentimentResponse().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): AnalyzeEntitySentimentResponse {
    return new AnalyzeEntitySentimentResponse().fromJsonString(jsonString, options);
  }

  static equals(a: AnalyzeEntitySentimentResponse | PlainMessage<AnalyzeEntitySentimentResponse> | undefined, b: AnalyzeEntitySentimentResponse | PlainMessage<AnalyzeEntitySentimentResponse> | undefined): boolean {
    return proto3.util.equals(AnalyzeEntitySentimentResponse, a, b);
  }
}
 ...
 *
 * @generated from message google.cloud.language.v1beta2.AnalyzeEntitiesRequest
 */
export class AnalyzeEntitiesRequest extends Message<AnalyzeEntitiesRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.cloud.language.v1beta2.AnalyzeEntitiesRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "document", kind: "message", T: Document },
    { no: 2, name: "encoding_type", kind: "enum", T: proto3.getEnumType(EncodingType) },
  ]);
 ...
 *
 * @generated from message google.cloud.language.v1beta2.AnalyzeEntitiesResponse
 */
export class AnalyzeEntitiesResponse extends Message<AnalyzeEntitiesResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.cloud.language.v1beta2.AnalyzeEntitiesResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "entities", kind: "message", T: Entity, repeated: true },
    { no: 2, name: "language", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
 ...
 *
 * @generated from message google.cloud.language.v1beta2.AnalyzeSyntaxRequest
 */
export class AnalyzeSyntaxRequest extends Message<AnalyzeSyntaxRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.cloud.language.v1beta2.AnalyzeSyntaxRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "document", kind: "message", T: Document },
    { no: 2, name: "encoding_type", kind: "enum", T: proto3.getEnumType(EncodingType) },
  ]);
 ...
 *
 * @generated from message google.cloud.language.v1beta2.AnalyzeSyntaxResponse
 */
export class AnalyzeSyntaxResponse extends Message<AnalyzeSyntaxResponse> {
  /**
   * Sentences in the input document.
   *
   * @generated from field: repeated google.cloud.language.v1beta2.Sentence sentences = 1;
   */
  sentences: Sentence[] = [];
   ...
   *
   * @generated from field: repeated google.cloud.language.v1beta2.Token tokens = 2;
   */
  tokens: Token[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.cloud.language.v1beta2.AnalyzeSyntaxResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message google.cloud.language.v1beta2.ClassifyTextRequest
 */
export class ClassifyTextRequest extends Message<ClassifyTextRequest> {
  /**
   * Input document.
   *
   * @generated from field: google.cloud.language.v1beta2.Document document = 1;
  ...
  constructor(data?: PartialMessage<ClassifyTextRequest>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.cloud.language.v1beta2.ClassifyTextRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "document", kind: "message", T: Document },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): ClassifyTextRequest {
    return new ClassifyTextRequest().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): ClassifyTextRequest {
    return new ClassifyTextRequest().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): ClassifyTextRequest {
    return new ClassifyTextRequest().fromJsonString(jsonString, options);
  }

  static equals(a: ClassifyTextRequest | PlainMessage<ClassifyTextRequest> | undefined, b: ClassifyTextRequest | PlainMessage<ClassifyTextRequest> | undefined): boolean {
    return proto3.util.equals(ClassifyTextRequest, a, b);
  }
}
 ...
 *
 * @generated from message google.cloud.language.v1beta2.ClassifyTextResponse
 */
export class ClassifyTextResponse extends Message<ClassifyTextResponse> {
  /**
   * Categories representing the input document.
   *
   * @generated from field: repeated google.cloud.language.v1beta2.ClassificationCategory categories = 1;
   */
  categories: ClassificationCategory[] = [];

  constructor(data?: PartialMessage<ClassifyTextResponse>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.cloud.language.v1beta2.ClassifyTextResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "categories", kind: "message", T: ClassificationCategory, repeated: true },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): ClassifyTextResponse {
    return new ClassifyTextResponse().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): ClassifyTextResponse {
    return new ClassifyTextResponse().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): ClassifyTextResponse {
    return new ClassifyTextResponse().fromJsonString(jsonString, options);
  }

  static equals(a: ClassifyTextResponse | PlainMessage<ClassifyTextResponse> | undefined, b: ClassifyTextResponse | PlainMessage<ClassifyTextResponse> | undefined): boolean {
    return proto3.util.equals(ClassifyTextResponse, a, b);
  }
}
 ...
 *
 * @generated from message google.cloud.language.v1beta2.AnnotateTextRequest
 */
export class AnnotateTextRequest extends Message<AnnotateTextRequest> {
   ...
   *
   * @generated from field: google.cloud.language.v1beta2.AnnotateTextRequest.Features features = 2;
   */
   ...
   * The encoding type used by the API to calculate offsets.
   *
   * @generated from field: google.cloud.language.v1beta2.EncodingType encoding_type = 3;
   */
  encodingType = EncodingType.NONE;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.cloud.language.v1beta2.AnnotateTextRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "document", kind: "message", T: Document },
 ...
 *
 * @generated from message google.cloud.language.v1beta2.AnnotateTextRequest.Features
 */
export class AnnotateTextRequest_Features extends Message<AnnotateTextRequest_Features> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.cloud.language.v1beta2.AnnotateTextRequest.Features";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 4, name: "extract_entity_sentiment", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
    { no: 6, name: "classify_text", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
  ]);
 ...
 *
 * @generated from message google.cloud.language.v1beta2.AnnotateTextResponse
 */
export class AnnotateTextResponse extends Message<AnnotateTextResponse> {
   ...
   *
   * @generated from field: repeated google.cloud.language.v1beta2.Entity entities = 3;
   */
  entities: Entity[] = [];
   ...
   *
   * @generated from field: google.cloud.language.v1beta2.Sentiment document_sentiment = 4;
   */
  documentSentiment?: Sentiment;
   ...
   *
   * @generated from field: repeated google.cloud.language.v1beta2.ClassificationCategory categories = 6;
   */
  categories: ClassificationCategory[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.cloud.language.v1beta2.AnnotateTextResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "sentences", kind: "message", T: Sentence, repeated: true },
    { no: 2, name: "tokens", kind: "message", T: Token, repeated: true },
    ...
    { no: 6, name: "categories", kind: "message", T: ClassificationCategory, repeated: true },
  ]);
