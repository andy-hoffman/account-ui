...
// @generated from file google/cloud/vision/v1p1beta1/text_annotation.proto (package google.cloud.vision.v1p1beta1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from message google.cloud.vision.v1p1beta1.TextAnnotation
 */
export class TextAnnotation extends Message<TextAnnotation> {
  /**
   * List of pages detected by OCR.
   *
   * @generated from field: repeated google.cloud.vision.v1p1beta1.Page pages = 1;
   */
  pages: Page[] = [];
  ...
  static readonly typeName = "google.cloud.vision.v1p1beta1.TextAnnotation";
 ...
 *
 * @generated from message google.cloud.vision.v1p1beta1.TextAnnotation.DetectedLanguage
 */
export class TextAnnotation_DetectedLanguage extends Message<TextAnnotation_DetectedLanguage> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.cloud.vision.v1p1beta1.TextAnnotation.DetectedLanguage";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message google.cloud.vision.v1p1beta1.TextAnnotation.DetectedBreak
 */
export class TextAnnotation_DetectedBreak extends Message<TextAnnotation_DetectedBreak> {
  /**
   * Detected break type.
   *
   * @generated from field: google.cloud.vision.v1p1beta1.TextAnnotation.DetectedBreak.BreakType type = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.cloud.vision.v1p1beta1.TextAnnotation.DetectedBreak";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from enum google.cloud.vision.v1p1beta1.TextAnnotation.DetectedBreak.BreakType
 */
...
proto3.util.setEnumType(TextAnnotation_DetectedBreak_BreakType, "google.cloud.vision.v1p1beta1.TextAnnotation.DetectedBreak.BreakType", [
  { no: 0, name: "UNKNOWN" },
  { no: 1, name: "SPACE" },
 ...
 *
 * @generated from message google.cloud.vision.v1p1beta1.TextAnnotation.TextProperty
 */
export class TextAnnotation_TextProperty extends Message<TextAnnotation_TextProperty> {
  /**
   * A list of detected languages together with confidence.
   *
   * @generated from field: repeated google.cloud.vision.v1p1beta1.TextAnnotation.DetectedLanguage detected_languages = 1;
   */
   ...
   *
   * @generated from field: google.cloud.vision.v1p1beta1.TextAnnotation.DetectedBreak detected_break = 2;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.cloud.vision.v1p1beta1.TextAnnotation.TextProperty";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message google.cloud.vision.v1p1beta1.Page
 */
export class Page extends Message<Page> {
  /**
   * Additional information detected on the page.
   *
   * @generated from field: google.cloud.vision.v1p1beta1.TextAnnotation.TextProperty property = 1;
   */
   ...
   *
   * @generated from field: repeated google.cloud.vision.v1p1beta1.Block blocks = 4;
   */
  blocks: Block[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.cloud.vision.v1p1beta1.Page";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message google.cloud.vision.v1p1beta1.Block
 */
export class Block extends Message<Block> {
   ...
   *
   * @generated from field: google.cloud.vision.v1p1beta1.BoundingPoly bounding_box = 2;
   */
   ...
   *
   * @generated from field: repeated google.cloud.vision.v1p1beta1.Paragraph paragraphs = 3;
   */
   ...
   *
   * @generated from field: google.cloud.vision.v1p1beta1.Block.BlockType block_type = 4;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.cloud.vision.v1p1beta1.Block";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "property", kind: "message", T: TextAnnotation_TextProperty },
 ...
 *
 * @generated from enum google.cloud.vision.v1p1beta1.Block.BlockType
 */
...
proto3.util.setEnumType(Block_BlockType, "google.cloud.vision.v1p1beta1.Block.BlockType", [
  { no: 0, name: "UNKNOWN" },
  { no: 1, name: "TEXT" },
  { no: 2, name: "TABLE" },
  { no: 3, name: "PICTURE" },
 ...
 *
 * @generated from message google.cloud.vision.v1p1beta1.Paragraph
 */
export class Paragraph extends Message<Paragraph> {
   ...
   *
   * @generated from field: repeated google.cloud.vision.v1p1beta1.Word words = 3;
   */
  words: Word[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.cloud.vision.v1p1beta1.Paragraph";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "property", kind: "message", T: TextAnnotation_TextProperty },
    { no: 2, name: "bounding_box", kind: "message", T: BoundingPoly },
 ...
 *
 * @generated from message google.cloud.vision.v1p1beta1.Word
 */
export class Word extends Message<Word> {
   ...
   *
   * @generated from field: repeated google.cloud.vision.v1p1beta1.Symbol symbols = 3;
   */
  symbols: Symbol[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.cloud.vision.v1p1beta1.Word";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "property", kind: "message", T: TextAnnotation_TextProperty },
    { no: 2, name: "bounding_box", kind: "message", T: BoundingPoly },
 ...
 *
 * @generated from message google.cloud.vision.v1p1beta1.Symbol
 */
export class Symbol extends Message<Symbol> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.cloud.vision.v1p1beta1.Symbol";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "property", kind: "message", T: TextAnnotation_TextProperty },
    { no: 2, name: "bounding_box", kind: "message", T: BoundingPoly },
